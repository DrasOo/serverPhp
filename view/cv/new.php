    ...
    <div class="row">
        <div class="col-12 bg-success text-white p-3 m-3 rounded shadow text-start min-vh-100">
            ...
            <div class="row mb-3">
                ...
                <form method="POST" class="user-form" id="userForm" action="">
                    <ul class="list-group p-3 d-flex"> <!-- Formulaire d'ajout de CV -->
                        ...
                        <li>
                            <button class="btn btn-primary mt-3" id="submitBtn" type="submit">Ajouter le CV</button>
                        </li>
                    </ul>
                    </form>
                </div>
